...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewOnas.setOnClickListener {
            val intent = Intent(this, Onas1::class.java)
            startActivity(intent)
        }
        ...
        val pfrLayout = findViewById<LinearLayout>(R.id.pfr)

        // Установим слушатель клика для области "pfr"
        pfrLayout.setOnClickListener {
            // Показываем BottomSheetDialog с layout bottom_sheet_layout_pf
            bottomSheetDialogPF.show()
        }
        //declaracii
        ...
        val declarLayout = findViewById<LinearLayout>(R.id.declar)

        // Установим слушатель клика для области "declar"
        declarLayout.setOnClickListener {
            // Показываем BottomSheetDialog с layout bottom_sheet_layout_dec
            bottomSheetDialogDec.show()
        }
         //ktc
        ...
        val ktcLayout = findViewById<LinearLayout>(R.id.ktc)

        // Установим слушатель клика для области "ktc"
        ktcLayout.setOnClickListener {
            // Показываем BottomSheetDialog с layout bottom_sheet_layout_ktc
            bottomSheetDialogKtc.show()
        }
        //eco
        ...
        val ecoLayout = findViewById<LinearLayout>(R.id.eco)

        // Установим слушатель клика для области "eco"
        ecoLayout.setOnClickListener {
            // Показываем BottomSheetDialog с layout bottom_sheet_layout_eco
            bottomSheetDialogEco.show()
        }
