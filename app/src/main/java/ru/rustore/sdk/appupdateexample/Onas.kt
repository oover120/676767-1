...
class Onas1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textКонтакты.setOnClickListener {
            ...
            val intent = Intent(this@Onas1, Page1::class.java)
            startActivity(intent)
        }

        val textView = findViewById<TextView>(R.id.main)
        textView.setOnClickListener {
            val intent = Intent(this@Onas1, MainActivity::class.java)
            startActivity(intent)
        }
        ...
        call_button.setOnClickListener {
            ...
            intent.data = Uri.parse("tel:89182744554") // замените YOUR_PHONE_NUMBER на номер телефона, на который нужно позвонить
            startActivity(intent)
        }
    }
}